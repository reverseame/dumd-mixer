...
def main(argv):
    ...
    #mix_tree, total_pages = mix_dumps_results_retAVL(files) # XXX
    print('done!')
    ...
    #import timeit; print(timeit.timeit("mix_dumps_results_AVL(files)", globals=globals(), setup="from __main__ import files", number=1))
    print('done!')
